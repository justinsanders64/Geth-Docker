...
geth --datadir gethdata --nodekeyhex 3028271501873c4ecf501a2d3945dcb64ea3f27d6f163af45eb23ced9e92d85b --networkid 1234565 --allow-insecure-unlock \
    --unlock 0x44B3Cbc9d59738A89B974c12623Cf5219C3b6b32 --password ~/password --authrpc.jwtsecret jwt.hex --syncmode full --http --http.addr 0.0.0.0 --http.port 8545 --http.api eth,net,web3 --http.corsdomain '*' \
